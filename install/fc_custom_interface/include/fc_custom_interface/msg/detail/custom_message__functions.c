...
fc_custom_interface__msg__CustomMessage__init(fc_custom_interface__msg__CustomMessage * msg)
{
  ...
  // int_a
  // str_b
  if (!rosidl_runtime_c__String__init(&msg->str_b)) {
    fc_custom_interface__msg__CustomMessage__fini(msg);
    return false;
  }
  // bool_c
  // str_d
  if (!rosidl_runtime_c__String__Sequence__init(&msg->str_d, 0)) {
    fc_custom_interface__msg__CustomMessage__fini(msg);
    return false;
  }
  return true;
...
fc_custom_interface__msg__CustomMessage__fini(fc_custom_interface__msg__CustomMessage * msg)
{
  ...
  // int_a
  // str_b
  rosidl_runtime_c__String__fini(&msg->str_b);
  // bool_c
  // str_d
  rosidl_runtime_c__String__Sequence__fini(&msg->str_d);
}
