...
size_t size_function__CustomMessage__str_d(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<std::string> *>(untyped_member);
  return member->size();
}

const void * get_const_function__CustomMessage__str_d(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__CustomMessage__str_d(void * untyped_member, size_t index)
{
  auto & member =
...
void resize_function__CustomMessage__str_d(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<std::string> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CustomMessage_message_member_array[4] = {
  {
    ...
    offsetof(fc_custom_interface::msg::CustomMessage, int_a),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fc_custom_interface::msg::CustomMessage, str_b),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fc_custom_interface::msg::CustomMessage, bool_c),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fc_custom_interface::msg::CustomMessage, str_d),  // bytes offset in struct
    nullptr,  // default value
    size_function__CustomMessage__str_d,  // size() function pointer
    get_const_function__CustomMessage__str_d,  // get_const(index) function pointer
    get_function__CustomMessage__str_d,  // get(index) function pointer
    resize_function__CustomMessage__str_d  // resize(index) function pointer
  }
};
